...
export const TITLE = 'AURA HAUS';
export const DESCRIPTION = 'spanish zora client. curated by Xcelencia';
export const GITHUB_REPO = 'https://github.com/SweetmanTech/aura-haus';
